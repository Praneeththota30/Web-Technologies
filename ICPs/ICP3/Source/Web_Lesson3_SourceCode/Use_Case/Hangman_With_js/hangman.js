var Hangman = (function () {
    ...
    function Hangman(elId) {
        ...
        // Dom is ready
        this.elId       = elId;
        this.words      = ['GORGEOUS', 'PROFESSOR', 'RELIABILITY', 'ORGANIZATION', 'COMPUTER'];
        this.hints      = {'GORGEOUS': ['beautiful', 'attractive',], 'PROFESSOR': ['TEACH'], 'RELIABILITY': ['trusty'], 'ORGANIZATION': ['COMPANY'], 'COMPUTER': ['PC']};
        this.hintimages = {'GORGEOUS':'./beauty.jpeg', 'PROFESSOR':'teacher.jpg', 'RELIABILITY':'./dependable.jpeg', 'ORGANIZATION':'./organization.jpeg', 'COMPUTER':'./computer.jpg'};
    }
